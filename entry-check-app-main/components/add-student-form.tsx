...
export function AddStudentForm() {
  ...
  const handleBulkUpload = async () => {
    ...
    try {
      ...
      if (selectedGrade === "all") {
        ...
        studentsToUpload = parsedData.students[normalizedGrade] || [];
      }
  ...
  return (
    <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="mt-8 flex justify-center">
            <Button
              type="submit"
              disabled={loading}
              className="px-8 py-3 bg-teal-500 hover:bg-teal-600 disabled:opacity-50"
            >
      ...
      {/* Modify and Delete Placeholders */}
      {mode !== "add" && mode !== "bulk" && (
