...
export default function ForgotPage() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    if (!username || !password) {
      setMessage("Please provide username and new password")
      return
    }
    if (password !== confirm) {
    ...
    // Allow resetting for existing user or creating new one via forgot flow
      ...
      <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <button className="px-4 py-2 bg-purple-600 text-white rounded-md">Set new password</button>
